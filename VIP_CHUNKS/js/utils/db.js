...
;(() => {
  ...
  function on_response ({ response, parsed_event, params  }) {
    ...
    console.log("on_response parameters", response, parsed_event, params, "::received");
...
async function _get (data) {
  ...
  console.log("_get parameter", data)
...
async function _post (data) {
  ...
  console.log("_post parameter", data)
...
async function _delete (data) {
  ...
  // console.log("_delete parameter", data)
...
async function _patch (data) {
  ...
  console.log("_patch parameter", data)
...
async function _fetch (data) {
  ...
  console.log("_fetch prameter", data)
  let { request, body } = data;
  let middle;

  try {

    console.log("_fetch Method_action ", request.method + "_" + body.action);
    ...
    SHOW_OBJECT_RESPONSE && console.log("_fetch recourse", data);
