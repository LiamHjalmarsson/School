...
function tryButton () {
  ...
  fetch(req)
    ...
    .then(r => {
      ...
      document.querySelector(".feedback").textContent = `We got the color ${r}`
    })
    .catch(e => {
      document.querySelector(".feedback").textContent = "Try it again"
      document.body.style.backgroundColor = "white"
    })
}

document.querySelector("button").addEventListener("click", tryButton)