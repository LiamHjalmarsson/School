...
users.forEach(user => {
    ...
    //     } else if (i == 1) {
    //         span.innerHTML = `${user.location.street.number} ${user.location.street.name} ${user.location.postcode} ${user.location.city} ${user.location.country}`; 
    //         span.classList.add("address")
    //     } else if (i == 2) {
    //         span.innerHTML = `${user.email}`; 
    //         span.classList.add("email")
    //     } else if (i == 3) {
    //         span.innerHTML =  `${user.cell} ${user.phone}`
    ...
    adressSpan.classList.add("address");
    emailSpan.classList.add("email");
    numberSpan.classList.add("phone");

    nameSpan.innerHTML = `${user.name.title} ${user.name.first} ${user.name.last}`; 
    adressSpan.innerHTML = `${user.location.street.number} ${user.location.street.name} ${user.location.postcode} ${user.location.city} ${user.location.country}`; 
    emailSpan.innerHTML = `${user.email}`; 
    numberSpan.innerHTML = `${user.cell} ${user.phone}`

    ul.append(li);
    li.append(nameSpan, adressSpan, emailSpan, numberSpan)
})