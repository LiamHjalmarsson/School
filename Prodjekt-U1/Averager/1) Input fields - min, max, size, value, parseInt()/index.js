...
let button_test_1 = document.getElementById("button_test_1");
...
button_test_1.addEventListener("click", function(){
...
// We can have several listeners for the same event o n the same element.
